...
# How to use
This repo will daily crawl arXiv papers about **cs.RO, cs.CV and cs.AI**, and use **Kimi** to summarize the papers in **Chinese**.
...
7. Create the following repository variables:
   ...
   6. `KEYWORDS`: optional hard filter before AI enhancement, separated with ",", such as "VLA,world model,UAV"
